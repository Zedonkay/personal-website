...
> [!TIP]
> After setting up al-folio you may want to run `python3 scripts/update_scholar_citations.py` to fill the `src/_data/citations.yml` file with your Google Scholar citation counts.
