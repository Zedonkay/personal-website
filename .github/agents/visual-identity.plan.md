...
- **Charms:** scatter in the gutters from the viewport edge in toward the text, mixed sizes, rotated, no collisions, not mirrored. The field stops at the footer line. Between the quote and the footer, charms may come inward as far as the outermost social icons — not into the icons or the footer. Motifs: teapot/cup, coffee mug, rolling pin, bike, clapper, whittling, theater masks, hammer, screwdriver, vinyl discs. No film-reel/wheel. Two vinyls: bottom-left and middle-right, each about 40–80% off the side or corner, still above the footer. Grooves/edge/label stay darker than the disc fill.
