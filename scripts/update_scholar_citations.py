...
def load_scholar_user_id() -> str:
    ...
    config_file = "src/_data/socials.yml"
    ...
    try:
        ...
        if not scholar_user_id:
            print(
                "No 'scholar_userid' found in the configuration file. Please add 'scholar_userid' to src/_data/socials.yml."
            )
            sys.exit(1)
...
OUTPUT_FILE: str = "src/_data/citations.yml"
